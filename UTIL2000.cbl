       ...
       PROGRAM-ID. UTIL1000.                                            00020000
      ***************************************************************** 00030000
      *  Programmer.:  Grant Peverett                                   00040001
      *  Date.......:  12-02-2026                                       00050001
      *  GitHub URL.:  https://github.com/Grantyy1/COBOL-Chapter-2-Assig00060004
      *  Description:  Depending on how much kilowatt of power detemines00070005
      *                tier of charge the customer will recieve.        00080005
      ******************************************************************00090005
       DATA DIVISION.                                                   00100005
       WORKING-STORAGE SECTION.                                         00110005
      ***************************************************************** 00120000
      * CONSTANTS                                                       00130000
      ***************************************************************** 00140000
      ...
      ***************************************************************** 00230000
       01  WS-CUST1.                                                    00240000
           ...
           05  WS-C1-FEE            PIC 9(3)V99 VALUE 14.95.            00270000
                                                                        00280000
       01  WS-CUST2.                                                    00281003
           05  WS-C2-NAME           PIC X(12)   VALUE 'CUST-BRAVO  '.   00282004
           05  WS-C2-KWH            PIC 9(5)    VALUE 925.              00283002
           05  WS-C2-FEE            PIC 9(3)V99 VALUE 14.95.            00284002
                                                                        00285001
       01  WS-CUST3.                                                    00286003
           05  WS-C3-NAME          PIC X(12)   VALUE  'CUST-CHARLIE'.   00287004
      ...
      ***************************************************************** 00640000
       000-MAIN.                                                        00650000
           ...
           DISPLAY ' '.                                                 00690000
                                                                        00700000
           PERFORM 500-LOAD-CUSTOMER1.                                  00710005
           PERFORM 600-RUN-BILL.                                        00720000
                                                                        00730000
           PERFORM 510-LOAD-CUSTOMER2.                                  00731005
           PERFORM 600-RUN-BILL.                                        00732005
                                                                        00733005
           PERFORM 520-LOAD-CUSTOMER3.                                  00734005
           PERFORM 600-RUN-BILL.                                        00735005
                                                                        00736005
           STOP RUN.                                                    00740000
                                                                        00750000
      ***************************************************************** 00760000
      ...
      ***************************************************************** 00780000
       500-LOAD-CUSTOMER1.                                              00790005
           MOVE WS-C1-NAME TO WS-CUST-NAME.                             00800000
           MOVE WS-C1-KWH  TO WS-KWH-USED.                              00810005
           MOVE WS-C1-FEE  TO WS-SERVICE-FEE.                           00820005
                                                                        00830000
       510-LOAD-CUSTOMER2.                                              00831005
           MOVE WS-C2-NAME TO WS-CUST-NAME.                             00832005
           MOVE WS-C2-KWH  TO WS-KWH-USED.                              00833005
           MOVE WS-C2-FEE  TO WS-SERVICE-FEE.                           00834005
                                                                        00835005
       520-LOAD-CUSTOMER3.                                              00836005
       ...
       300-CALC-CHARGES.                                                01430000
           COMPUTE WS-TIER1-CHARGE ROUNDED =                            01440000
               WS-TIER1-KWH * WS-RATE-TIER1.                            01450000
                                                                        01460000
                                                                        01480000
           COMPUTE WS-TIER2-CHARGE ROUNDED =                            01481003
               WS-TIER2-KWH * WS-RATE-TIER2.                            01482005
                                                                        01483003
                                                                        01485003
           COMPUTE WS-TIER3-CHARGE ROUNDED =                            01486003
               WS-TIER3-KWH * WS-RATE-TIER3.                            01487005
                                                                        01488003
           COMPUTE WS-SUBTOTAL = WS-TIER1-CHARGE                        01489005
               + WS-TIER2-CHARGE + WS-TIER3-CHARGE.                     01489105
